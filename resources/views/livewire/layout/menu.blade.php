<nav x-data="{ open: false }" class="absolute inset-x-0 top-0 z-50 bg-white border-b border-gray-100">
    <div class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <a href="/" class="text-lg font-semibold leading-6 text-white" wire:navigate>Home</a>
            <a href="" class="text-lg font-semibold leading-6 text-white" wire:navigate>About us</a>
            <a href="" class="text-lg font-semibold leading-6 text-white">Our
                team</a>
            <a href="" class="text-lg font-semibold leading-6 text-white" wire:navigate>Events</a>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="" class="text-lg font-semibold leading-6 text-white" wire:navigate>Contact us
